			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/brand/R.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Paid') }}"> الفواتير المدفوعه و المدفوعه جزئيا</a></li>
							@endif
							@if (Auth::user()->role== 'admin')
								
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_UnPaid') }}">الفواتير الغير المدفوعه</a></li>
							@endif
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='allUsers') }}">قائمه المستخدمين</a></li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">   <span       class="side-menu__label">الاعدادات</span><i class="angle fe fe-chevron-down"></i>
						</a>
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='add-user') }}"> اضافه مستخدم</a></li>
							@endif
						</ul>
