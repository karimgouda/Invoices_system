							...
							<div class="card-body">
								<div class="table-responsive">
									<div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mb-5">
										<a class="modal-effect btn btn-success btn-block" data-effect="effect-fall" data-toggle="modal" href="#modaldemo1">اضافه منتج</a>
									</div> 
					...
					<div class="modal-content modal-content-demo">
						...
						<div class="modal-body">
							<div class=" form-group">
								<label for="exampleInput">اسم المنتج</label>
								<input type="text" class=" form-control" id="section_name" name="product_name" placeholder="اسم المنتج">
							</div>
